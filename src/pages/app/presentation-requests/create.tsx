...
import { useDatabase, useHolder, usePeerDID, useVerifier } from "@trust0/identus-react/hooks";
...
function CreatePresentationRequestPage() {
    ...
    const [claims, setClaims] = useState<Claim[]>([{ id: uuidv4(), name: "", value: "" }]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const message = await parseOOB(`${window.location.origin}/app/credentials?oob=${code}`);
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    {isSubmitting && (
                        <div className="bg-white/95 dark:bg-[#0A0A0A]/95 backdrop-blur-lg p-6 rounded-xl border border-gray-200 dark:border-gray-800 text-center mb-6 shadow-lg">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Setting up your presentation request...</p>
                            <div className="p-4">
                        ...
                        <div className="space-y-6">
                                ...
                                <div  className="flex items-center space-x-3 p-3 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-700">
                                            <div className="flex-1">
                                                <input
                                                    type="text"
                                                    value={trustIssuer}
                                                    onChange={(e) => handleTrustIssuerChange(e.target.value)}
                            ...
                            <div className="bg-gray-50/50 dark:bg-gray-800/30 backdrop-blur-sm p-6 rounded-xl border border-gray-200 dark:border-gray-700">
                                <div className="flex justify-between items-center mb-4">
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-800 dark:text-white">Required Claims</h3>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">Specify the claims you want to verify</p>
                                    </div>
                                    ...
                                    {showTemplates && (
                                        ...
                                        >
                                            <div className="p-4 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-700">
                                                <h4 className="text-sm font-medium text-gray-800 dark:text-white mb-3">Select a verification template</h4>
